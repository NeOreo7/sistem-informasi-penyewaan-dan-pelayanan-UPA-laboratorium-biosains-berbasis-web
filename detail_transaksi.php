			...
			<div class="container">
    			...
    			<div class="col-md-8 ftco-animate">
    				<div class="cart-list bg-light p-5" style="border-radius: 10px;">
                        <h2 class="mb-4">Detail Transaksi #ORD-001</h2>
                        <div class="d-flex justify-content-between mb-3">
                            <span class="font-weight-bold">Status:</span>
                            <span class="badge badge-warning" style="padding: 10px; font-size: 14px;">Menunggu Konfirmasi</span>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span>12 Oktober 2026, 10:00 WIB</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <h4 class="font-weight-bold text-primary">Rp 500.000</h4>
                        </div>
                        <p class="text-muted mt-3">Pesanan Anda sedang menunggu konfirmasi dari admin. Mohon ditunggu.</p>
